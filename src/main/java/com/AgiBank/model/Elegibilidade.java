...
public class Elegibilidade {
    ...
    private int calcularMesesTrabalhadosAntesDe2019(int userId) {
        ...
        if (ultimaContribuicao.isBefore(limite2019)) {
            return (int) ChronoUnit.MONTHS.between(primeiraContribuicao, ultimaContribuicao);
        } else {
            return (int) ChronoUnit.MONTHS.between(primeiraContribuicao, limite2019);
        }
    }

    private int calcularIdade(String dataNascimento, int anoReferencia) {
